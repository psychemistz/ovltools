...
model = glm(label ~ X95735_at+M55150_at+M16038_at+M23197_at+M57710_at, data=train_dset, family = 'binomial')
cls = predict(model, test_dset, type="response")

# confusion matrix
table(test_dset$label, round(cls))

# ACC 
print(paste("ACC:", round((19+13)/34, 3)))
```
