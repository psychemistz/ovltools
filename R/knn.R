## This code is adopted from AmRMR paper.  Reference: 2019, Insik Jo, Improved Measures of Redundancy and Relevance for mRMR Feature
## Selection.  Codebase: https://bitldku.github.io/home/sw/R-value.html Many thanks to the professor Sejong Oh (Kunkook University) who
## kindly share his work.

## Modified by Seongyong Park (2020-08-18) Rvalue provides estimated overlap between two classes or more. Here I assumed only two classes.
